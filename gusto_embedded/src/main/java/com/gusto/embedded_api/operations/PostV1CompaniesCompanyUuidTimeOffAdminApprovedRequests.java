...
public class PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequests {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsRequest, com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsResponse res = resBuilder.build();
