...
public class PostV1PayrollDigests {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1PayrollDigestsRequest, com.gusto.embedded_api.models.operations.async.PostV1PayrollDigestsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1PayrollDigestsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1PayrollDigestsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1PayrollDigestsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1PayrollDigestsResponse res = resBuilder.build();
