...
public class DeleteV1CompaniesCompanyIdBankAccountsBankAccountId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdResponse res = resBuilder.build();
