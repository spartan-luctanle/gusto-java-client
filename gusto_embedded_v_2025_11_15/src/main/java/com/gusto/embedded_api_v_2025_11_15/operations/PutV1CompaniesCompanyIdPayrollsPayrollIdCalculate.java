...
public class PutV1CompaniesCompanyIdPayrollsPayrollIdCalculate {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateResponse res = resBuilder.build();
