...
public class DeleteV1RecurringReimbursements {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1RecurringReimbursementsRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1RecurringReimbursementsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1RecurringReimbursementsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1RecurringReimbursementsResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1RecurringReimbursementsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1RecurringReimbursementsResponse res = resBuilder.build();
