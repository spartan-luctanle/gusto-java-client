...
public class DeleteV1CompaniesCompanyUuidHolidayPayPolicy {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1CompaniesCompanyUuidHolidayPayPolicyRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1CompaniesCompanyUuidHolidayPayPolicyResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1CompaniesCompanyUuidHolidayPayPolicyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1CompaniesCompanyUuidHolidayPayPolicyResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1CompaniesCompanyUuidHolidayPayPolicyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1CompaniesCompanyUuidHolidayPayPolicyResponse res = resBuilder.build();
