...
public class PutV1CompanyIndustry {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompanyIndustryRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1CompanyIndustryResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1CompanyIndustryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1CompanyIndustryResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1CompanyIndustryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1CompanyIndustryResponse res = resBuilder.build();
