...
public class PutV1CompaniesCompanyIdPayrollsPayrollIdSubmit {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyIdPayrollsPayrollIdSubmitRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdSubmitResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdSubmitResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdSubmitResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdSubmitResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdSubmitResponse res = resBuilder.build();
