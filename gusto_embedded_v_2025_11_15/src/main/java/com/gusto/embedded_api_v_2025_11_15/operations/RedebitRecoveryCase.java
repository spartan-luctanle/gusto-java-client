...
public class RedebitRecoveryCase {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RedebitRecoveryCaseRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.RedebitRecoveryCaseResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.RedebitRecoveryCaseResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.RedebitRecoveryCaseResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.RedebitRecoveryCaseResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.RedebitRecoveryCaseResponse res = resBuilder.build();
