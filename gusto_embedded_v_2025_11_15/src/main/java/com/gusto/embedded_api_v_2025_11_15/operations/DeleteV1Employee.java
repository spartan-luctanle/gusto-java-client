...
public class DeleteV1Employee {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1EmployeeRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1EmployeeResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1EmployeeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1EmployeeResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1EmployeeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1EmployeeResponse res = resBuilder.build();
