...
import com.gusto.embedded_api_v_2025_11_15.models.components.Flow;
...
public class PostV1CompanyFlows {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompanyFlowsRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.PostV1CompanyFlowsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.PostV1CompanyFlowsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.PostV1CompanyFlowsResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.PostV1CompanyFlowsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.PostV1CompanyFlowsResponse res = resBuilder.build();
