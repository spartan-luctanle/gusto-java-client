...
public class PutV1TaxLiabilitiesFinish {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1TaxLiabilitiesFinishRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1TaxLiabilitiesFinishResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1TaxLiabilitiesFinishResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1TaxLiabilitiesFinishResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1TaxLiabilitiesFinishResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.PutV1TaxLiabilitiesFinishResponse res = resBuilder.build();
