...
public class DeleteV1ExternalPayroll {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1ExternalPayrollRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1ExternalPayrollResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1ExternalPayrollResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1ExternalPayrollResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1ExternalPayrollResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1ExternalPayrollResponse res = resBuilder.build();
