...
public class ContractorPaymentForGroupPreview {
    ...
    /**
     * An optional invoice number associated with this contractor payment. This will be visible to the
     * contractor on their paystub. Maximum 25 characters.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    public ContractorPaymentForGroupPreview(
            ...
            @JsonProperty("invoice_number") JsonNullable<String> invoiceNumber,
     ...
     * contractor on their paystub. Maximum 25 characters.
     */
    public ContractorPaymentForGroupPreview withInvoiceNumber(String invoiceNumber) {
        Utils.checkNotNull(invoiceNumber, "invoiceNumber");
     ...
     * contractor on their paystub. Maximum 25 characters.
     */
    public ContractorPaymentForGroupPreview withInvoiceNumber(JsonNullable<String> invoiceNumber) {
        Utils.checkNotNull(invoiceNumber, "invoiceNumber");
        this.invoiceNumber = invoiceNumber;
        return this;
    }
     ...
     * their paystub.
     */
    public ContractorPaymentForGroupPreview withMemo(String memo) {
        Utils.checkNotNull(memo, "memo");
     ...
     * their paystub.
     */
    public ContractorPaymentForGroupPreview withMemo(JsonNullable<String> memo) {
        Utils.checkNotNull(memo, "memo");
        this.memo = memo;
        return this;
    }
