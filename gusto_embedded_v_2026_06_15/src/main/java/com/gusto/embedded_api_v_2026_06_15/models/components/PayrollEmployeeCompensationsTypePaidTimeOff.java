...
public class PayrollEmployeeCompensationsTypePaidTimeOff {
     ...
     * "1234.56"). Only available for processed payrolls.
     */
    public PayrollEmployeeCompensationsTypePaidTimeOff withAmount(String amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * "1234.56"). Only available for processed payrolls.
     */
    public PayrollEmployeeCompensationsTypePaidTimeOff withAmount(JsonNullable<String> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
