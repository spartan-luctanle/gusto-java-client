...
public class ContractorPaymentBody {
     ...
     * contractor on their paystub. Maximum 25 characters.
     */
    public ContractorPaymentBody withInvoiceNumber(String invoiceNumber) {
        Utils.checkNotNull(invoiceNumber, "invoiceNumber");
     ...
     * contractor on their paystub. Maximum 25 characters.
     */
    public ContractorPaymentBody withInvoiceNumber(Optional<String> invoiceNumber) {
        Utils.checkNotNull(invoiceNumber, "invoiceNumber");
        this.invoiceNumber = invoiceNumber;
        return this;
    }
     ...
     * their paystub.
     */
    public ContractorPaymentBody withMemo(String memo) {
        Utils.checkNotNull(memo, "memo");
     ...
     * their paystub.
     */
    public ContractorPaymentBody withMemo(Optional<String> memo) {
        Utils.checkNotNull(memo, "memo");
        this.memo = memo;
        return this;
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            wage, hours, bonus,
            reimbursement, invoiceNumber, memo);
    }
