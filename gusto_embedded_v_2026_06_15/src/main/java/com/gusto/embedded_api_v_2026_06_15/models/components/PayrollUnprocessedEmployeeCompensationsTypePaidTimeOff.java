...
public class PayrollUnprocessedEmployeeCompensationsTypePaidTimeOff {
    ...
    /**
     * The dollar amount paid for this PTO entry during the pay period (as a string-formatted decimal, e.g.
     * "1234.56"). Only available for processed payrolls.
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("amount")
     ...
     * "1234.56"). Only available for processed payrolls.
     */
    public PayrollUnprocessedEmployeeCompensationsTypePaidTimeOff withAmount(String amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * "1234.56"). Only available for processed payrolls.
     */
    public PayrollUnprocessedEmployeeCompensationsTypePaidTimeOff withAmount(JsonNullable<String> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
