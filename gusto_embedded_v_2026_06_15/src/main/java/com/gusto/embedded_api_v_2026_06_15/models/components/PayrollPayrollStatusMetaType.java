...
public class PayrollPayrollStatusMetaType {
    ...
    /**
     * The normal check date for the associated pay period. Returns `null` for off-cycle payrolls (not
     * meaningful for off-cycle).
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("initial_check_date")
    private JsonNullable<String> initialCheckDate;
    ...
    /**
     * expected_check_date &gt; initial_check_date. Returns `null` for off-cycle payrolls (not meaningful
     * for off-cycle).
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("payroll_late")
    private JsonNullable<Boolean> payrollLate;
    ...
    public PayrollPayrollStatusMetaType(
            ...
            @JsonProperty("initial_check_date") JsonNullable<String> initialCheckDate,
            @JsonProperty("expected_debit_time") Optional<String> expectedDebitTime,
            @JsonProperty("payroll_late") JsonNullable<Boolean> payrollLate,
     ...
     */
    @JsonIgnore
    public JsonNullable<String> initialCheckDate() {
     ...
     */
    @JsonIgnore
    public JsonNullable<Boolean> payrollLate() {
        return payrollLate;
    }
    ...
    public PayrollPayrollStatusMetaType withInitialCheckDate(String initialCheckDate) {
        Utils.checkNotNull(initialCheckDate, "initialCheckDate");
        this.initialCheckDate = JsonNullable.of(initialCheckDate);
        return this;
    }
     ...
     * meaningful for off-cycle).
     */
    public PayrollPayrollStatusMetaType withInitialCheckDate(JsonNullable<String> initialCheckDate) {
        Utils.checkNotNull(initialCheckDate, "initialCheckDate");
        this.initialCheckDate = initialCheckDate;
        return this;
    }
    ...
    public PayrollPayrollStatusMetaType withPayrollLate(boolean payrollLate) {
        Utils.checkNotNull(payrollLate, "payrollLate");
        this.payrollLate = JsonNullable.of(payrollLate);
        return this;
    }
     ...
     * for off-cycle).
     */
    public PayrollPayrollStatusMetaType withPayrollLate(JsonNullable<Boolean> payrollLate) {
        Utils.checkNotNull(payrollLate, "payrollLate");
        this.payrollLate = payrollLate;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private JsonNullable<String> initialCheckDate = JsonNullable.undefined();

        private Optional<String> expectedDebitTime = Optional.empty();

        private JsonNullable<Boolean> payrollLate = JsonNullable.undefined();
         ...
         * meaningful for off-cycle).
         */
        public Builder initialCheckDate(JsonNullable<String> initialCheckDate) {
            Utils.checkNotNull(initialCheckDate, "initialCheckDate");
            this.initialCheckDate = initialCheckDate;
            return this;
        }
         ...
         * for off-cycle).
         */
        public Builder payrollLate(JsonNullable<Boolean> payrollLate) {
            Utils.checkNotNull(payrollLate, "payrollLate");
            this.payrollLate = payrollLate;
            return this;
        }
