...
| `contractorPayments`                                                                      | List\<[ContractorPayments](../../models/components/ContractorPayments.md)>                | :heavy_minus_sign:                                                                        | The individual contractor payments, within a given time period, grouped by contractor.    |