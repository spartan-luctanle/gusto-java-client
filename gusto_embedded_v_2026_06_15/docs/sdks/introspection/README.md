...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        OauthAccessTokenResponse res = sdk.introspection().oauthAccessToken()
                .xGustoAPIVersion(OauthAccessTokenHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS06_MINUS15)
...
import com.gusto.embedded_api_v_2026_06_15.GustoEmbedded;
import com.gusto.embedded_api_v_2026_06_15.models.operations.GetV1TokenInfoHeaderXGustoAPIVersion;
...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        GetV1TokenInfoResponse res = sdk.introspection().getInfo()
                .xGustoAPIVersion(GetV1TokenInfoHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS06_MINUS15)
                .call();
