...
import com.gusto.embedded_api_v_2026_06_15.models.components.CreateFlowRequest;
...
import com.gusto.embedded_api_v_2026_06_15.models.operations.PostV1CompanyFlowsHeaderXGustoAPIVersion;
import com.gusto.embedded_api_v_2026_06_15.models.operations.PostV1CompanyFlowsResponse;
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, UnprocessableEntityError, Exception {
        ...
        PostV1CompanyFlowsResponse res = sdk.flows().create()
                .xGustoAPIVersion(PostV1CompanyFlowsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS06_MINUS15)
                .companyUuid("<id>")
