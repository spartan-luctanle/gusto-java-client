...
import com.gusto.embedded_api_v_2026_06_15.models.operations.GetV1EmployeeFormsHeaderXGustoAPIVersion;
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, Exception {
        ...
        GetV1EmployeeFormsResponse res = sdk.employeeForms().list()
                .xGustoAPIVersion(GetV1EmployeeFormsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS06_MINUS15)
                .employeeId("<id>")
                .call();
...
import com.gusto.embedded_api_v_2026_06_15.GustoEmbedded;
import com.gusto.embedded_api_v_2026_06_15.models.errors.NotFoundErrorObject;
import com.gusto.embedded_api_v_2026_06_15.models.operations.GetV1EmployeeFormHeaderXGustoAPIVersion;
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, Exception {
        ...
        GetV1EmployeeFormResponse res = sdk.employeeForms().get()
                .xGustoAPIVersion(GetV1EmployeeFormHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS06_MINUS15)
                .employeeId("<id>")
                .formId("<id>")
                .call();
...
import com.gusto.embedded_api_v_2026_06_15.GustoEmbedded;
import com.gusto.embedded_api_v_2026_06_15.models.errors.NotFoundErrorObject;
import com.gusto.embedded_api_v_2026_06_15.models.operations.GetV1EmployeeFormPdfHeaderXGustoAPIVersion;
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, Exception {
        ...
        GetV1EmployeeFormPdfResponse res = sdk.employeeForms().getPdf()
                .xGustoAPIVersion(GetV1EmployeeFormPdfHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS06_MINUS15)
                .employeeId("<id>")
                .formId("<id>")
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, UnprocessableEntityError, Exception {
        ...
        PostV1SandboxGenerateW2Response res = sdk.employeeForms().generateW2()
                .xGustoAPIVersion(PostV1SandboxGenerateW2HeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS06_MINUS15)
