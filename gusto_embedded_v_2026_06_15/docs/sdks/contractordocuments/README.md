...
import com.gusto.embedded_api_v_2026_06_15.models.operations.GetV1ContractorDocumentsHeaderXGustoAPIVersion;
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, Exception {
        ...
        GetV1ContractorDocumentsResponse res = sdk.contractorDocuments().getAll()
                .xGustoAPIVersion(GetV1ContractorDocumentsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS06_MINUS15)
                .contractorUuid("<id>")
                .call();
...
import com.gusto.embedded_api_v_2026_06_15.models.operations.GetV1ContractorDocumentHeaderXGustoAPIVersion;
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, UnprocessableEntityError, Exception {
        ...
        GetV1ContractorDocumentResponse res = sdk.contractorDocuments().get()
                .xGustoAPIVersion(GetV1ContractorDocumentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS06_MINUS15)
                .documentUuid("<id>")
                .call();
...
import com.gusto.embedded_api_v_2026_06_15.models.errors.NotFoundErrorObject;
import com.gusto.embedded_api_v_2026_06_15.models.errors.UnprocessableEntityError;
import com.gusto.embedded_api_v_2026_06_15.models.operations.GetV1ContractorDocumentPdfHeaderXGustoAPIVersion;
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, UnprocessableEntityError, Exception {
        ...
        GetV1ContractorDocumentPdfResponse res = sdk.contractorDocuments().getPdf()
                .xGustoAPIVersion(GetV1ContractorDocumentPdfHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS06_MINUS15)
                .documentUuid("<id>")
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, UnprocessableEntityError, Exception {
        ...
        PutV1ContractorDocumentSignResponse res = sdk.contractorDocuments().sign()
                .xGustoAPIVersion(PutV1ContractorDocumentSignHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS06_MINUS15)
                .documentUuid("<id>")
