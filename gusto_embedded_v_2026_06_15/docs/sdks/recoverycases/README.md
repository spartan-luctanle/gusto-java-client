...
import com.gusto.embedded_api_v_2026_06_15.models.operations.GetRecoveryCasesHeaderXGustoAPIVersion;
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, Exception {
        ...
        GetRecoveryCasesResponse res = sdk.recoveryCases().get()
                .xGustoAPIVersion(GetRecoveryCasesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS06_MINUS15)
                .companyUuid("<id>")
                .call();
...
import com.gusto.embedded_api_v_2026_06_15.models.operations.RedebitRecoveryCaseHeaderXGustoAPIVersion;
import com.gusto.embedded_api_v_2026_06_15.models.operations.RedebitRecoveryCaseResponse;
import java.lang.Exception;
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, UnprocessableEntityError, Exception {
        ...
        RedebitRecoveryCaseResponse res = sdk.recoveryCases().redebit()
                .xGustoAPIVersion(RedebitRecoveryCaseHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS06_MINUS15)
                .recoveryCaseUuid("<id>")
                .call();
