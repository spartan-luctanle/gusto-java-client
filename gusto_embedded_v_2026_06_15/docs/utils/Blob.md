...
The [`Blob`](../../src/main/java/com/gusto/embedded_api_v_2026_06_15/utils/Blob.java) class provides factory methods for various input sources:
...
The [`Blob`](../../src/main/java/com/gusto/embedded_api_v_2026_06_15/utils/Blob.java) class provides four methods for reading/consuming the data. All consumption methods use NIO and are safe to use in asynchronous contexts:
